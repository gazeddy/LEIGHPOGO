...
def replace_once(path: str, old: str, new: str) -> None:
    ...
    if count != 1:
        raise SystemExit(f"Expected one literal match in {path}, found {count}")
