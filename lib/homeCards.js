...
const getCampfireCard = (campfireUrl) =>
  campfireUrl
    ? {
        href: campfireUrl,
        title: "Campfire",
        description: "Open the Leigh Pokémon GO Campfire community for local raids, meetups and updates.",
        label: "Community",
        tone: "campfire",
        external: true,
        cta: "Open Campfire",
...
export function getHomeCards({
  ...
  const campfireCard = getCampfireCard(campfireUrl)

  return [
    ...PUBLIC_CARDS,
    ...(campfireCard ? [campfireCard] : []),
